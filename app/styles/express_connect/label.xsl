					...
					function barCode(barString) 
						{
							...
							{
								grow = grow + '<img width="14" height="60" src="https://www.upela.com/css/express_connect/barcode/' + myCode[i] + '" />';
							}
					...
					<table width="550" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="2" align="center" height="150" valign="middle">
								...
								<xsl:value-of select="CONSIGNMENT/DELIVERYDEPOTNAME/@depotCode"/>
								<br/>
								<img src="{$hostName}/barcode/barbecue?data={HEADER/COLLECTIONDEPOTNAME/@depotCode}{format-number(HEADER/SENDER/ACCOUNT, '0000000000')}{substring(CONSIGNMENT/CONNUMBER, 1, 8)}{format-number(PACKAGEINDEX, '000')}{CONSIGNMENT/DELIVERYDEPOTNAME/@depotCode}&amp;type=UCC128&amp;appid=6&amp;height=105"/>
							</td>
						</tr>
					</table>
				</td>
				...
				<xsl:when test="HEADER/COLLECTION/COMPANYNAME/text()">
					<tr>
						...
						<td align="center" width="300" colspan="2">
							<img src="https://www.upela.com/css/express_connect/images/logo.gif"/>
							<br/>
							<br/>
							<span id="barcode"><script language="JavaScript" type="text/javascript">document.write(barCode(&apos;*<xsl:value-of select="CONSIGNMENT/CONNUMBER"/>*&apos;));</script></span>
							<br/>
							<font class="header">*<xsl:value-of select="CONSIGNMENT/CONNUMBER"/>*</font>
							<br/>
							<br/>
